...
does not choose languages, load translation files, or translate application
content. Your application can obtain expressions from code, a translation
service, a database, or user and system configuration.
