...
func buttonClasses(cfg config) string {
	base := "min-h-11 min-w-11 whitespace-nowrap rounded-2xl font-medium tracking-wide transition motion-reduce:transition-none hover:contrast-125 text-center focus-visible:outline-2 focus-visible:outline-offset-2 active:contrast-100 active:outline-offset-0 disabled:opacity-75 disabled:cursor-not-allowed border"
