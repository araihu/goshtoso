...
func menuItemClasses(danger bool) string {
	if danger {
		return "block bg-surface-alt px-4 py-2 text-sm text-danger-text hover:bg-danger/5 focus-visible:bg-danger/10 focus-visible:outline-hidden dark:bg-surface-dark-alt dark:text-danger-text-dark dark:hover:bg-danger/10"
	}
