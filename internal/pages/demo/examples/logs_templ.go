...
func LogRow(line logs.LogLine) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/pages/demo/examples/logs.templ`, Line: 34, Col: 33}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/pages/demo/examples/logs.templ`, Line: 44, Col: 106}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/pages/demo/examples/logs.templ`, Line: 45, Col: 96}
		}
...
func LogsApp() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "</div></div><!-- Persistent feed + filter wrapper --><div x-ref=\"feedWrap\" x-on:htmx:after-swap=\"onSwap($event)\" x-on:htmx:sse-open=\"connected = true\" x-on:htmx:sse-error=\"connected = false\" class=\"flt-all rounded-radius border border-outline dark:border-outline-dark\"><div id=\"log-feed\" class=\"h-80 overflow-y-auto\"></div></div><!-- SSE connector: removed on pause (closes EventSource), targets the persistent feed --><template x-if=\"!paused\"><div hx-ext=\"sse\" sse-connect=\"/api/examples/logs/stream\"><div sse-swap=\"message\" hx-target=\"#log-feed\" hx-swap=\"beforeend\" hidden></div></div></template></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
