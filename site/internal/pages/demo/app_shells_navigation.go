	...
	return []appShellsSidebarLink{
		{
			...
			Description: "Layouts for documentation, applications, and public sites.",
		},
	}
}
			...
			Items: []appShellsSidebarLink{
				{
					...
					Description: "Document a component with previews, code samples, and usage notes.",
				},
			},
		},
		{
			...
			Items: []appShellsSidebarLink{
				{
					...
					Description: "Documentation layout with sidebar search, section navigation, and a table of contents.",
				},
				{
					ID:          "app-shells-shell-console",
					Label:       "Console Shell",
					Href:        "/modules/app-shells/shells/console-shell",
					Description: "Application layout with a header, sidebar, mobile drawer, and HTMX navigation.",
				},
				{
					ID:          "app-shells-shell-landing",
					Label:       "Landing Shell",
					Href:        "/modules/app-shells/shells/landing-shell",
					Description: "Landing page layout with responsive navigation, a hero section, and footer links.",
				},
			},
		},
	}
