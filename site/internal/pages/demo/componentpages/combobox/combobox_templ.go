...
@combobox.Combobox(IndustryCfg, combobox.State{Options: IndustryCfg.Source.Static})`,
		...
		templ_7745c5c3_Err = demo.ExpressionOverridesNote("Combobox").Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func comboboxClusterPreview() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `site/internal/pages/demo/componentpages/combobox/combobox.templ`, Line: 239, Col: 39}
		}
