...
func dropdownDemoContent() templ.Component {
    ...
    Sections: []dropdown.Section{
		...
		templ_7745c5c3_Err = demo.ExpressionOverridesNote("Dropdown").Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func dropdownActionsPreview() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = dropdown.Dropdown(dropdown.Config{
			ID:              "dropdown-actions",
			Label:           "cluster actions",
			TriggerIcon:     ddDotsVerticalIcon(),
			TriggerIconOnly: true,
			Sections: []dropdown.Section{
				{Items: []dropdown.Item{
					{
...
func ddDotsVerticalIcon() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
