...
func iconPackExtension() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = codeblock.CodeBlock(codeblock.Config{
			...
			Code: `# Assets v0.2.0 is public; use this after the Goshtoso v0.2.0 tag is public:
go run github.com/araihu/goshtoso/cmd/iconpack@v0.2.0 \
	-release-archive ./araihu-assets-v0.2.0.tar.gz \
	-archive-sha256 5d7d691e22d4071507b0bf2248713d7008adf57c18840cfd46e20901db0b78e5 -release v0.2.0 \
