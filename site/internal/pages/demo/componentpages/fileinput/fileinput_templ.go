...
func fileInputDemoContent() templ.Component {
    ...
    HelperText: "PNG, JPG, WebP - Max 5MB",
		...
		templ_7745c5c3_Err = demo.ExpressionOverridesNote("FileInput").Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func fileInputUploadPreview() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<div id=\"fileinput-upload\" class=\"grid w-full max-w-md mx-auto\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = fileinput.FileInput(fileinput.Config{
