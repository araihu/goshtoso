...
var runtimeAttributionDefinitions = []runtimeAttributionDefinition{
	...
	{Attribution: attribution{Name: "htmx Alpine compatibility", Href: "https://four.htmx.org/extensions/hx-alpine-compat", License: "Zero-Clause BSD", Note: "Coordinates Alpine initialization and state during htmx swaps"}, Role: assets.RuntimeAssetRole("htmx-alpine-compat"), Version: assets.HTMXVersion, FallbackLocalURL: assets.HTMXAlpineCompatURL},
	...
	{Attribution: attribution{Name: "htmx SSE extension", Href: "https://four.htmx.org/extensions/hx-sse", License: "Zero-Clause BSD", Note: "Server-sent event integration"}, Role: assets.RuntimeAssetRole("htmx-ext-sse"), Version: assets.HTMXExtSSEVersion, FallbackLocalURL: assets.HTMXExtSSEURL},
	{Attribution: attribution{Name: "htmx WebSocket extension", Href: "https://four.htmx.org/extensions/hx-ws", License: "Zero-Clause BSD", Note: "WebSocket integration"}, Role: assets.RuntimeAssetRole("htmx-ext-ws"), Version: assets.HTMXExtWSVersion, FallbackLocalURL: assets.HTMXExtWSURL},
}
