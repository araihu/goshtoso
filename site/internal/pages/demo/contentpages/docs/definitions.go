...
var Definitions = []demo.PageDefinition{
	...
	{Key: "docs/iconpack", Title: "Icon Packs", Active: "iconpack", Description: "Generate consumer-local icon packs from Arai Hu Assets or any hashed SVG source manifest and render them through Goshtoso's core icon component.", Type: "TechArticle", Content: iconpackContent},
