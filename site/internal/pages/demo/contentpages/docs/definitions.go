...
var Definitions = []demo.PageDefinition{
	...
	{Key: "docs/iconpack", Title: "Icon Packs", Active: "iconpack", Description: "Generate consumer-local icon packs from Arai Hu Assets, GitHub trees, single files, or multiple arbitrary sources with an iconpack-owned TOFU lock.", Type: "TechArticle", Content: iconpackContent},
