...
var sidebarAPISections = []demo.APISection{
	...
	demo.StructAPI[sidebar.Item](
		...
		[]demo.APIPropDoc{
			...
			{Name: "Active", Default: "false", Description: "Selects active styling for top-level items and leaf section items. Section items with children take their child/disclosure branch first; top-level active links omit Badge."},
	...
	demo.StructAPI[sidebar.OverlayConfig](
		...
		[]demo.APIPropDoc{
			{Name: "ID", Default: `"sidebarOverlay" state and "sidebar-overlay-panel" panel ID`, Description: "Derives Alpine state and the panel ID; non-empty input produces <ID>-panel."},
