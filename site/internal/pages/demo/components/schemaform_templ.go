...
var schemaFormAPISections = []demo.APISection{
	...
	demo.FunctionsAPI(
		...
		[]demo.APIPropDoc{
			{Name: "AllowMode", Signature: "type AllowMode string", Default: `"" (editable path)`, Allowed: []string{"AllowModeManaged", "AllowModeDisabled"}, Description: "Names the per-path allow-list policy used by the schema transforms."},
