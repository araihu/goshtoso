...
var Demos = map[string]DemoEntry{
	...
	"components/schema-form":      {"Schema Form", "schema-form", schemaFormDemoContent},
	...
	"docs/component-model":        {"Component Model", "component-model", componentModelContent},
...
func demoDescription(key string, entry DemoEntry) string {
	descriptions := map[string]string{
		...
		"components/schema-form":      "Generate complete form sections from JSON Schema defaults, submitted values, and allow-list rules in server-rendered Go interfaces.",
