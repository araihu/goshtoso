...
func tableDemoContent() templ.Component {
    ...
    Pagination: &table.PaginationConfig{
		...
		templ_7745c5c3_Err = demo.APIReference([]demo.PropDoc{
			...
			{Name: "Appearance", Type: "Appearance", Default: "AppearanceDefault", Description: `Visual treatment: default or striped.`},
			...
			{Name: "Filters", Type: "*FilterConfig", Default: "nil", Description: "Filter bar config (Appearance, Collapsible, Filters[]: search/select/toggle)."},
			{Name: "Filters.Appearance", Type: "FilterAppearance", Default: "FilterAppearanceBar", Description: "Switches between the bordered/collapsible filter bar and inline filter controls."},
