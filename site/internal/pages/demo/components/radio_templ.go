...
var radioAPISections = []demo.APISection{
	demo.StructAPI[radio.Config](
		...
		[]demo.APIPropDoc{
			...
			{Name: "HelperTextID", Default: `"" (helper has no ID)`, Description: "For standalone Radio with non-empty HelperText, identifies the helper element and supplies the input aria-describedby value. RadioGroup still puts this value on aria-describedby but does not give its helper span a matching id."},
			...
			{Name: "Container", Default: "false", Description: "Selects the bordered standalone Radio layout; RadioGroup ignores it as an item-layout selector."},
