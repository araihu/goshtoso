...
var carouselAPISections = []demo.APISection{
	demo.StructAPI[carousel.Config](
		...
		[]demo.APIPropDoc{
			...
			{Name: "Autoplay", Default: "nil (disabled)", Description: "Optional automatic-rotation settings."},
			{Name: "Touch", Default: "false", Description: "Enables horizontal swipe navigation."},
			{Name: "AspectRatio", Default: `"min-h-[50svh]"`, Description: `Frame aspect ratio such as "3/1"; Height takes precedence.`},
			{Name: "Height", Default: `"" (AspectRatio or min-height used)`, Description: "Tailwind height classes for the slide frame."},
