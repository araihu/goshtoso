...
var componentPages = []Entry{
	...
	},
	{
		...
		Title:       "Card",
		Active:      "card",
		Description: "Compose structured card layouts in Go with media, headings, body content, actions, and responsive variants.",
		Section:     "Display",
		Order:       4,
	...
	},
	{
		...
		Title:       "Carousel",
		Active:      "carousel",
		Description: "Render carousel content rails for images, feature panels, and grouped cards with Goshtoso, templ, and Alpine.js.",
		Section:     "Display",
		Order:       5,
