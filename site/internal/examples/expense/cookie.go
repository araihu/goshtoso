// internal/examples/expense/cookie.go
package expense

import "net/http"

// CookieName is the cookie that carries the encoded expense State.
const CookieName = "gt_expense"
...
// both /examples/* and /api/examples/expense/* (a narrower path would not reach
// the API endpoints).
