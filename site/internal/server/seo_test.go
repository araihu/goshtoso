...
func TestComponentPageRendersSEOMetadata(t *testing.T) {
	...
	require.Contains(t, body, `<meta property="og:image" content="https://goshtoso.araihu.com/assets/images/goshtoso-social-card.png">`)
	require.Contains(t, body, `<meta name="twitter:image" content="https://goshtoso.araihu.com/assets/images/goshtoso-social-card.png">`)
	...
	require.Contains(t, body, `<meta property="og:image:alt" content="Goshtoso wordmark beside a sunglasses-wearing Go gopher in Rio, with Button, Input, Alert, and Card UI previews.">`)
	require.Contains(t, body, `<meta name="twitter:image:alt" content="Goshtoso wordmark beside a sunglasses-wearing Go gopher in Rio, with Button, Input, Alert, and Card UI previews.">`)
	require.Equal(t, 1, strings.Count(body, `property="og:image"`))
	require.Equal(t, 1, strings.Count(body, `property="og:image:alt"`))
	require.Equal(t, 1, strings.Count(body, `name="twitter:image"`))
	require.Equal(t, 1, strings.Count(body, `name="twitter:image:alt"`))
