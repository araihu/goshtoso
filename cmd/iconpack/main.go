...
func run(ctx context.Context, args []string) error {
	...
	fs.StringVar(&opts.ReleaseRoot, "release-root", "", "verified extracted release root or dist root")
	fs.StringVar(&opts.ReleaseArchive, "release-archive", "", "verified .tar.gz or .zip release archive")
