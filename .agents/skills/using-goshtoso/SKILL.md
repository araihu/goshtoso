...
`head.Dependencies()` emits Goshtoso CSS and an ordered loader for the Alpine
collapse/focus/mask plugins, the first-party `/assets/js/goshtoso.min.js`
bundle, HTMX 4, `hx-alpine-compat`, and Alpine.js. Third-party dependencies try
